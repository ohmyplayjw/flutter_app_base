      ...
      child: Stack(children: [
        Container(
          decoration: BoxDecoration(
            color: const Color.fromARGB(255, 45, 185, 105),
            border: Border.all(
          ...
          child:
            ...
            Container(
              ...
              child: Column(children: [
                Padding(
                  padding:
                      const EdgeInsets.only(left: 3.0, top: 16.0, right: 3.0),
                  child: PlayerCard(
                ...
                Padding(
                  padding:
                      const EdgeInsets.only(left: 3.0, bottom: 16.0, right: 3),
                  child: PlayerCard(
                      bgColor: isAteamPositionChanged
                          ? Colors.white
                          : const Color.fromARGB(255, 255, 255, 255),
            ...
            Container(
              ...
              child: Column(children: [
                Padding(
                  padding: const EdgeInsets.only(top: 16.0, right: 3),
                  child: PlayerCard(
                ...
                Padding(
                  padding: const EdgeInsets.only(bottom: 16.0, right: 3.0),
                  child: PlayerCard(
                      bgColor: isBteamPositionChanged
                          ? const Color.fromARGB(255, 255, 255, 255)
                          : Colors.white,
