...
class MainScreenState extends State<MainScreen>
  ...
  final aTeamPlayer1Provider = StateProvider<Player?>((ref) => null);
  final aTeamPlayer2Provider = StateProvider<Player?>((ref) => null);
  final bTeamPlayer1Provider = StateProvider<Player?>((ref) => null);
  final bTeamPlayer2Provider = StateProvider<Player?>((ref) => null);
